...
class QuestionH extends Component {
    ...
    render() { 
        ...
        <div className="tdiv">
     {/* <h1>table created</h1> */}
     <table className="table mytable table-striped table-hover borderless" style={{borderTop: 'none'}}>
           ...
           <tr>
             ...
             <td className="align-middle">
                 ...
                 <div className="progress pbar" >
                     <div className="progress-bar inner-pbar " style={{width: question.accuracy}}>
                     {question.accuracy}
                     </div>
                 </div>
